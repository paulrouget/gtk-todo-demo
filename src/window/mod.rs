...
use gtk::{gio, glib, Align, CheckButton, CustomFilter, Dialog, DialogFlags, Entry, FilterListModel, NoSelection, ResponseType, SelectionMode};

use crate::collection::{CollectionData, CollectionObject, CollectionRow};
  ...
  fn setup_collections(&self) {
    ...
    self.imp().collections_list.bind_model(
      ...
      clone!(@weak self as window => @default-panic, move |obj| {
          ...
          CollectionRow::new(collection_object).upcast()
      }),
    )
  }
